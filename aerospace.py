...
with open("уир.csv", encoding="utf8") as f:
    ...
    for i, row in enumerate(reader):
        ...
        applicants.append(Enrolee(lst1[0], lst1[21:24], lst1[1]))


fac1 = Faculty("Энергетическое машиностроение", 10)
fac2 = Faculty("Материаловедение и технологии материалов", 9)
fac3 = Faculty("Наноматериалы", 12)
...
faculties = [fac1.num_vacant_places, fac2.num_vacant_places, fac3.num_vacant_places, unpassed.num_vacant_places]
facs = [fac1, fac2, fac3, unpassed]
f = {
    "Энергетическое машиностроение": 0,
    "Материаловедение и технологии материалов": 1,
    "Наноматериалы": 2,
    'Не прошел': 3
}
